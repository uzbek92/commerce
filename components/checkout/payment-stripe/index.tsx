...
const CardNumber = ({ options }: { options: StripeCardNumberElementOptions }) => {
  return (
    <div className="relative border-b border-gray-200 py-2">
      <span className="text-base-regular absolute -top-6 text-gray-700">Card number</span>
...
const CardExpiry = ({ options }: { options: StripeCardExpiryElementOptions }) => {
  return (
    <div className="relative w-full border-b border-gray-200 py-2">
      <span className="text-base-regular absolute -top-6 text-gray-700">Expiration date</span>
...
const CardCVC = ({ options }: { options: StripeCardCvcElementOptions }) => {
  return (
    <div className="relative w-full border-b border-gray-200 py-2">
      <span className="text-base-regular absolute -top-6 text-gray-700">CVC</span>
